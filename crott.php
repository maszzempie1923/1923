...
echo
"\e[32;1m*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*\n";
echo "\e[37;1m*************** \e[93minstagram : @MaszzEmpie\e[37;1m **************\n";
echo "\e[32;1m*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*\n";
echo "\e[31;1m    || >>>>>>>>\e[1;33m".date('[d-m-Y] [H:i:s]')."\e[31;1m<<<<<<<< ||\n";
echo "\e[32;1m*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*\n";
echo "\e[32;1m*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*\n";
echo "\e[31;1m*•*•*•*•*•*•*•*•*•*•\e[93mMaszzEmpie\e[31;1m•*•*•*•*•*•*•*•*•*•*\n";
echo "\e[32;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo "\e[93m*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*\n";
...
// function change(){
        ...
        echo color("white","📶▶️ MAU NGAPAIN HAYO!! ")."\n";
        otp:
        echo color("green","💬▶️ SINI DI MASUKIN : ");
       ...
       echo "\n".color("purple","# CLAIM VOUCHER PACAR TEMEN");
        echo "\n".color("blue","# CROTT LUAR YA!!! ");
        for($a=1;$a<=3;$a++){
        echo color("purple",".");
        sleep(30);
        }
       $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"COBAGOFOOD2107"}');
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
	      gocar:
        echo "\n".color("green","# CLAIM VOUCHER PACAR PERTAMA");
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
        gofood:
        echo "\n".color("white","# CLAIM VOUCHER PACAR KEDUA");
        ...
        echo "\n".color("yellow","# CLAIM VOUCHER SELINGKUHAN");
        echo "\n".color("white","# BENTAR LAGI CROTT");
        for($a=1;$a<=3;$a++){
        echo color("white",".");
        sleep(5);
        }
